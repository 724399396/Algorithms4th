public class MyBTree <Key extends Comparable<Key>, Value> {
	...
	private static final class Node {
		private int m;				// number of childer
	...
	// constructor
	public MyBTree() { root = new Node(0); }
	
	// return number of key-value paris in the B-tree
	...
	// comparison functions -make Comprable instead od Key to avoid casts
